...
export const ROOMS: Room[] = [
  ...
  { roomNumber: '102', wardId: 'ward1', beds: [
    ...
    { bed: 'B', patientId: null, patientName: null, status: 'empty', gender: null, age: null },
  ]},
  ...
  { roomNumber: '205', wardId: 'ward2', beds: [
    { bed: 'A', patientId: null, patientName: null, status: 'empty', gender: null, age: null },
    { bed: 'B', patientId: 'P018', patientName: '斎藤 恵', status: 'stable', gender: 'F', age: 64 },
  ]},
];
...
export const PATIENTS: Patient[] = [
  ...
  { id: 'P018', name: '斎藤 恵',     age: 64, gender: 'F', wardId: 'ward2', roomNumber: '205', bedLabel: 'B', status: 'stable',       admitDate: '2026-01-22', doctorName: '森田 医師', diagnosis: 'うつ病' },
];
