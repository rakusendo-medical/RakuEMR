...
export const ROOMS: Room[] = [
  // 第１病棟（101〜109号室、各8床。ベッド番号は 1, 2, 3, 5, 6, 7, 8, 9 — 4 は不吉な数字のためスキップ）
  { roomNumber: '101', wardId: 'ward1', beds: [
    { bed: '1', patientId: 'P001', patientName: '山田 太郎',     status: 'stable',       gender: 'M', age: 52 },
    { bed: '2', patientId: 'P002', patientName: '佐藤 花子',     status: 'observation',  gender: 'F', age: 67 },
    { bed: '3', patientId: 'P021', patientName: '後藤 幸子',     status: 'stable',       gender: 'F', age: 46 },
    { bed: '5', patientId: 'P022', patientName: '小川 浩',       status: 'stable',       gender: 'M', age: 39 },
    { bed: '6', patientId: 'P069', patientName: '柴田 直樹',     status: 'stable',       gender: 'M', age: 42 },
    { bed: '7', patientId: 'P070', patientName: '岡田 早苗',     status: 'stable',       gender: 'F', age: 55 },
    { bed: '8', patientId: null,   patientName: null,            status: 'empty',        gender: null, age: null },
    { bed: '9', patientId: null,   patientName: null,            status: 'empty',        gender: null, age: null },
  ]},
  { roomNumber: '102', wardId: 'ward1', beds: [
    { bed: '1', patientId: 'P003', patientName: '鈴木 一郎',     status: 'isolation',    gender: 'M', age: 41, flags: ['isolation', 'reportRequired'] },
    { bed: '2', patientId: 'P023', patientName: '中山 誠一',     status: 'stable',       gender: 'M', age: 62 },
    { bed: '3', patientId: 'P024', patientName: '宮田 典子',     status: 'stable',       gender: 'F', age: 34, flags: ['deposit'] },
    { bed: '5', patientId: null,   patientName: null,            status: 'empty',        gender: null, age: null, disabled: true },
    { bed: '6', patientId: 'P071', patientName: '橋本 隆',       status: 'stable',       gender: 'M', age: 48 },
    { bed: '7', patientId: 'P072', patientName: '森下 真由美',   status: 'observation',  gender: 'F', age: 37 },
    { bed: '8', patientId: null,   patientName: null,            status: 'empty',        gender: null, age: null },
    { bed: '9', patientId: null,   patientName: null,            status: 'empty',        gender: null, age: null },
  ]},
  { roomNumber: '103', wardId: 'ward1', beds: [
    { bed: '1', patientId: 'P004', patientName: '高橋 美咲',     status: 'restraint',    gender: 'F', age: 35, flags: ['restraint', 'reportRequired'] },
    { bed: '2', patientId: 'P005', patientName: '田中 健太',     status: 'stable',       gender: 'M', age: 29 },
    { bed: '3', patientId: 'P025', patientName: '石川 裕二',     status: 'stable',       gender: 'M', age: 28 },
    { bed: '5', patientId: 'P026', patientName: '原 由美子',     status: 'stable',       gender: 'F', age: 53 },
    { bed: '6', patientId: 'P073', patientName: '小野寺 浩',     status: 'stable',       gender: 'M', age: 64 },
    { bed: '7', patientId: null,   patientName: null,            status: 'empty',        gender: null, age: null },
    { bed: '8', patientId: null,   patientName: null,            status: 'empty',        gender: null, age: null },
    { bed: '9', patientId: null,   patientName: null,            status: 'empty',        gender: null, age: null },
  ]},
  { roomNumber: '104', wardId: 'ward1', beds: [
    { bed: '1', patientId: 'P006', patientName: '伊藤 幸子',     status: 'outing',       gender: 'F', age: 58, flags: ['outing', 'deposit'] },
    { bed: '2', patientId: 'P007', patientName: '渡辺 大輔',     status: 'stable',       gender: 'M', age: 44, flags: ['overnight'], hasScheduledMove: true },
    { bed: '3', patientId: 'P027', patientName: '内田 道子',     status: 'stable',       gender: 'F', age: 55 },
    { bed: '5', patientId: 'P074', patientName: '武田 さゆり',   status: 'stable',       gender: 'F', age: 31 },
    { bed: '6', patientId: 'P075', patientName: '長谷川 慎',     status: 'observation',  gender: 'M', age: 53 },
    { bed: '7', patientId: 'P076', patientName: '池田 雅美',     status: 'stable',       gender: 'F', age: 40 },
    { bed: '8', patientId: null,   patientName: null,            status: 'empty',        gender: null, age: null },
    { bed: '9', patientId: null,   patientName: null,            status: 'empty',        gender: null, age: null },
  ]},
  { roomNumber: '105', wardId: 'ward1', beds: [
    { bed: '1', patientId: 'P008', patientName: '中村 裕子',     status: 'observation',  gender: 'F', age: 73 },
    { bed: '2', patientId: 'P028', patientName: '西川 雅之',     status: 'stable',       gender: 'M', age: 51 },
    { bed: '3', patientId: 'P029', patientName: '坂本 千恵子',   status: 'stable',       gender: 'F', age: 43 },
    { bed: '5', patientId: 'P077', patientName: '青木 浩司',     status: 'stable',       gender: 'M', age: 70 },
  ...
  { roomNumber: '106', wardId: 'ward1', beds: [
    { bed: '1', patientId: 'P009', patientName: '小林 誠',       status: 'stable',       gender: 'M', age: 38 },
    { bed: '2', patientId: 'P010', patientName: '加藤 良子',     status: 'stable',       gender: 'F', age: 61 },
    { bed: '3', patientId: 'P030', patientName: '安田 正人',     status: 'stable',       gender: 'M', age: 57 },
    { bed: '5', patientId: 'P031', patientName: '谷口 沙織',     status: 'stable',       gender: 'F', age: 29 },
    { bed: '6', patientId: 'P079', patientName: '飯田 弘',       status: 'stable',       gender: 'M', age: 36 },
    { bed: '7', patientId: null,   patientName: null,            status: 'empty',        gender: null, age: null },
    { bed: '8', patientId: null,   patientName: null,            status: 'empty',        gender: null, age: null },
    { bed: '9', patientId: null,   patientName: null,            status: 'empty',        gender: null, age: null },
  ]},
  { roomNumber: '107', wardId: 'ward1', beds: [
    { bed: '1', patientId: 'P019', patientName: '新井 太一',     status: 'stable',       gender: 'M', age: 22 },
    { bed: '2', patientId: 'P032', patientName: '矢野 健一',     status: 'restraint',    gender: 'M', age: 36 },
    { bed: '3', patientId: 'P033', patientName: '川崎 麻美',     status: 'stable',       gender: 'F', age: 27 },
    { bed: '5', patientId: 'P080', patientName: '森本 京子',     status: 'stable',       gender: 'F', age: 58 },
    { bed: '6', patientId: 'P081', patientName: '関口 健一',     status: 'observation',  gender: 'M', age: 45 },
    { bed: '7', patientId: null,   patientName: null,            status: 'empty',        gender: null, age: null },
    { bed: '8', patientId: null,   patientName: null,            status: 'empty',        gender: null, age: null },
    { bed: '9', patientId: null,   patientName: null,            status: 'empty',        gender: null, age: null },
  ]},
  { roomNumber: '108', wardId: 'ward1', beds: [
    { bed: '1', patientId: 'P034', patientName: '福本 美恵子',   status: 'stable',       gender: 'F', age: 69 },
    { bed: '2', patientId: 'P035', patientName: '西田 智也',     status: 'stable',       gender: 'M', age: 25 },
    { bed: '3', patientId: 'P036', patientName: '高瀬 久美子',   status: 'stable',       gender: 'F', age: 54 },
    { bed: '5', patientId: 'P082', patientName: '河野 友美',     status: 'stable',       gender: 'F', age: 32 },
    { bed: '6', patientId: 'P083', patientName: '吉川 修',       status: 'stable',       gender: 'M', age: 61 },
    { bed: '7', patientId: null,   patientName: null,            status: 'empty',        gender: null, age: null },
    { bed: '8', patientId: null,   patientName: null,            status: 'empty',        gender: null, age: null },
    { bed: '9', patientId: null,   patientName: null,            status: 'empty',        gender: null, age: null },
  ]},
  { roomNumber: '109', wardId: 'ward1', beds: [
    { bed: '1', patientId: 'P037', patientName: '杉本 健二',     status: 'stable',       gender: 'M', age: 33 },
    { bed: '2', patientId: 'P038', patientName: '徳田 美代子',   status: 'stable',       gender: 'F', age: 60 },
    { bed: '3', patientId: 'P084', patientName: '南 真理子',     status: 'stable',       gender: 'F', age: 44 },
    { bed: '5', patientId: 'P085', patientName: '中島 大輔',     status: 'stable',       gender: 'M', age: 27 },
    { bed: '6', patientId: 'P086', patientName: '佐野 恵',       status: 'observation',  gender: 'F', age: 52 },
    { bed: '7', patientId: null,   patientName: null,            status: 'empty',        gender: null, age: null },
    { bed: '8', patientId: null,   patientName: null,            status: 'empty',        gender: null, age: null },
    { bed: '9', patientId: null,   patientName: null,            status: 'empty',        gender: null, age: null },
  ]},
...
export const PATIENTS: Patient[] = [
  // 第１病棟
  { id: 'P001', name: '山田 太郎',     age: 52, gender: 'M', wardId: 'ward1', roomNumber: '101', bedLabel: '1', status: 'stable',      admitDate: '2026-01-10', doctorName: '田村 医師', diagnosis: '統合失調症', primaryRecordType: 'nursing-record' },
  { id: 'P002', name: '佐藤 花子',     age: 67, gender: 'F', wardId: 'ward1', roomNumber: '101', bedLabel: '2', status: 'observation',  admitDate: '2026-01-15', doctorName: '岸本 医師', diagnosis: 'うつ病' },
  { id: 'P021', name: '後藤 幸子',     age: 46, gender: 'F', wardId: 'ward1', roomNumber: '101', bedLabel: '3', status: 'stable',       admitDate: '2026-01-18', doctorName: '岸本 医師', diagnosis: 'うつ病' },
  { id: 'P022', name: '小川 浩',       age: 39, gender: 'M', wardId: 'ward1', roomNumber: '101', bedLabel: '5', status: 'stable',       admitDate: '2026-02-05', doctorName: '田村 医師', diagnosis: '適応障害' },
  { id: 'P003', name: '鈴木 一郎',     age: 41, gender: 'M', wardId: 'ward1', roomNumber: '102', bedLabel: '1', status: 'isolation',    admitDate: '2026-02-01', doctorName: '森田 医師', diagnosis: '双極性障害' },
  { id: 'P023', name: '中山 誠一',     age: 62, gender: 'M', wardId: 'ward1', roomNumber: '102', bedLabel: '2', status: 'stable',       admitDate: '2025-12-10', doctorName: '森田 医師', diagnosis: '統合失調症' },
  { id: 'P024', name: '宮田 典子',     age: 34, gender: 'F', wardId: 'ward1', roomNumber: '102', bedLabel: '3', status: 'stable',       admitDate: '2026-01-30', doctorName: '岸本 医師', diagnosis: '双極性障害' },
  { id: 'P004', name: '高橋 美咲',     age: 35, gender: 'F', wardId: 'ward1', roomNumber: '103', bedLabel: '1', status: 'restraint',    admitDate: '2026-02-05', doctorName: '田村 医師', diagnosis: '統合失調症' },
  { id: 'P005', name: '田中 健太',     age: 29, gender: 'M', wardId: 'ward1', roomNumber: '103', bedLabel: '2', status: 'stable',       admitDate: '2026-01-20', doctorName: '岸本 医師', diagnosis: '適応障害' },
  { id: 'P025', name: '石川 裕二',     age: 28, gender: 'M', wardId: 'ward1', roomNumber: '103', bedLabel: '3', status: 'stable',       admitDate: '2026-02-20', doctorName: '田村 医師', diagnosis: '適応障害' },
  { id: 'P026', name: '原 由美子',     age: 53, gender: 'F', wardId: 'ward1', roomNumber: '103', bedLabel: '5', status: 'stable',       admitDate: '2026-01-12', doctorName: '森田 医師', diagnosis: 'うつ病' },
  { id: 'P006', name: '伊藤 幸子',     age: 58, gender: 'F', wardId: 'ward1', roomNumber: '104', bedLabel: '1', status: 'outing',       admitDate: '2026-01-08', doctorName: '森田 医師', diagnosis: 'うつ病' },
  { id: 'P007', name: '渡辺 大輔',     age: 44, gender: 'M', wardId: 'ward1', roomNumber: '104', bedLabel: '2', status: 'stable',       admitDate: '2026-02-10', doctorName: '田村 医師', diagnosis: 'アルコール依存症' },
  { id: 'P027', name: '内田 道子',     age: 55, gender: 'F', wardId: 'ward1', roomNumber: '104', bedLabel: '3', status: 'stable',       admitDate: '2025-12-22', doctorName: '岸本 医師', diagnosis: '認知症' },
  { id: 'P008', name: '中村 裕子',     age: 73, gender: 'F', wardId: 'ward1', roomNumber: '105', bedLabel: '1', status: 'observation',  admitDate: '2026-01-25', doctorName: '岸本 医師', diagnosis: '認知症' },
  { id: 'P028', name: '西川 雅之',     age: 51, gender: 'M', wardId: 'ward1', roomNumber: '105', bedLabel: '2', status: 'stable',       admitDate: '2026-01-08', doctorName: '田村 医師', diagnosis: '統合失調症' },
  { id: 'P029', name: '坂本 千恵子',   age: 43, gender: 'F', wardId: 'ward1', roomNumber: '105', bedLabel: '3', status: 'stable',       admitDate: '2026-02-03', doctorName: '森田 医師', diagnosis: 'うつ病' },
  { id: 'P009', name: '小林 誠',       age: 38, gender: 'M', wardId: 'ward1', roomNumber: '106', bedLabel: '1', status: 'stable',       admitDate: '2026-02-12', doctorName: '森田 医師', diagnosis: '不安障害' },
  { id: 'P010', name: '加藤 良子',     age: 61, gender: 'F', wardId: 'ward1', roomNumber: '106', bedLabel: '2', status: 'stable',       admitDate: '2026-01-30', doctorName: '田村 医師', diagnosis: 'うつ病' },
  { id: 'P030', name: '安田 正人',     age: 57, gender: 'M', wardId: 'ward1', roomNumber: '106', bedLabel: '3', status: 'stable',       admitDate: '2026-01-19', doctorName: '岸本 医師', diagnosis: 'アルコール依存症' },
  { id: 'P031', name: '谷口 沙織',     age: 29, gender: 'F', wardId: 'ward1', roomNumber: '106', bedLabel: '5', status: 'stable',       admitDate: '2026-02-11', doctorName: '田村 医師', diagnosis: '摂食障害' },
  { id: 'P019', name: '新井 太一',     age: 22, gender: 'M', wardId: 'ward1', roomNumber: '107', bedLabel: '1', status: 'stable',       admitDate: '2026-02-24', doctorName: '田村 医師', diagnosis: '適応障害' },
  { id: 'P032', name: '矢野 健一',     age: 36, gender: 'M', wardId: 'ward1', roomNumber: '107', bedLabel: '2', status: 'restraint',    admitDate: '2026-02-19', doctorName: '森田 医師', diagnosis: '双極性障害' },
  { id: 'P033', name: '川崎 麻美',     age: 27, gender: 'F', wardId: 'ward1', roomNumber: '107', bedLabel: '3', status: 'stable',       admitDate: '2026-02-16', doctorName: '岸本 医師', diagnosis: '適応障害' },
  { id: 'P034', name: '福本 美恵子',   age: 69, gender: 'F', wardId: 'ward1', roomNumber: '108', bedLabel: '1', status: 'stable',       admitDate: '2025-12-05', doctorName: '田村 医師', diagnosis: '認知症' },
  { id: 'P035', name: '西田 智也',     age: 25, gender: 'M', wardId: 'ward1', roomNumber: '108', bedLabel: '2', status: 'stable',       admitDate: '2026-02-22', doctorName: '森田 医師', diagnosis: 'うつ病' },
  { id: 'P036', name: '高瀬 久美子',   age: 54, gender: 'F', wardId: 'ward1', roomNumber: '108', bedLabel: '3', status: 'stable',       admitDate: '2026-01-25', doctorName: '岸本 医師', diagnosis: '統合失調症' },
  { id: 'P037', name: '杉本 健二',     age: 33, gender: 'M', wardId: 'ward1', roomNumber: '109', bedLabel: '1', status: 'stable',       admitDate: '2026-02-14', doctorName: '田村 医師', diagnosis: '不安障害' },
  { id: 'P038', name: '徳田 美代子',   age: 60, gender: 'F', wardId: 'ward1', roomNumber: '109', bedLabel: '2', status: 'stable',       admitDate: '2026-01-06', doctorName: '森田 医師', diagnosis: 'うつ病' },
  // 第１病棟 8 ベッド化に伴う追加入院患者
  { id: 'P069', name: '柴田 直樹',     age: 42, gender: 'M', wardId: 'ward1', roomNumber: '101', bedLabel: '6', status: 'stable',       admitDate: '2026-03-02', doctorName: '田村 医師', diagnosis: '統合失調症' },
  { id: 'P070', name: '岡田 早苗',     age: 55, gender: 'F', wardId: 'ward1', roomNumber: '101', bedLabel: '7', status: 'stable',       admitDate: '2026-03-10', doctorName: '岸本 医師', diagnosis: 'うつ病' },
  { id: 'P071', name: '橋本 隆',       age: 48, gender: 'M', wardId: 'ward1', roomNumber: '102', bedLabel: '6', status: 'stable',       admitDate: '2026-03-15', doctorName: '森田 医師', diagnosis: '双極性障害' },
  { id: 'P072', name: '森下 真由美',   age: 37, gender: 'F', wardId: 'ward1', roomNumber: '102', bedLabel: '7', status: 'observation',  admitDate: '2026-03-20', doctorName: '岸本 医師', diagnosis: '適応障害' },
  { id: 'P073', name: '小野寺 浩',     age: 64, gender: 'M', wardId: 'ward1', roomNumber: '103', bedLabel: '6', status: 'stable',       admitDate: '2026-02-28', doctorName: '田村 医師', diagnosis: '認知症' },
  { id: 'P074', name: '武田 さゆり',   age: 31, gender: 'F', wardId: 'ward1', roomNumber: '104', bedLabel: '5', status: 'stable',       admitDate: '2026-03-05', doctorName: '岸本 医師', diagnosis: 'うつ病' },
  { id: 'P075', name: '長谷川 慎',     age: 53, gender: 'M', wardId: 'ward1', roomNumber: '104', bedLabel: '6', status: 'observation',  admitDate: '2026-03-12', doctorName: '田村 医師', diagnosis: 'アルコール依存症' },
  { id: 'P076', name: '池田 雅美',     age: 40, gender: 'F', wardId: 'ward1', roomNumber: '104', bedLabel: '7', status: 'stable',       admitDate: '2026-03-22', doctorName: '森田 医師', diagnosis: '不安障害' },
  { id: 'P077', name: '青木 浩司',     age: 70, gender: 'M', wardId: 'ward1', roomNumber: '105', bedLabel: '5', status: 'stable',       admitDate: '2026-02-26', doctorName: '田村 医師', diagnosis: '認知症' },
  { id: 'P078', name: '岡本 久美',     age: 49, gender: 'F', wardId: 'ward1', roomNumber: '105', bedLabel: '6', status: 'stable',       admitDate: '2026-03-08', doctorName: '岸本 医師', diagnosis: '統合失調症' },
  { id: 'P079', name: '飯田 弘',       age: 36, gender: 'M', wardId: 'ward1', roomNumber: '106', bedLabel: '6', status: 'stable',       admitDate: '2026-03-18', doctorName: '森田 医師', diagnosis: '適応障害' },
  { id: 'P080', name: '森本 京子',     age: 58, gender: 'F', wardId: 'ward1', roomNumber: '107', bedLabel: '5', status: 'stable',       admitDate: '2026-02-25', doctorName: '森田 医師', diagnosis: 'うつ病' },
  { id: 'P081', name: '関口 健一',     age: 45, gender: 'M', wardId: 'ward1', roomNumber: '107', bedLabel: '6', status: 'observation',  admitDate: '2026-03-09', doctorName: '田村 医師', diagnosis: '双極性障害' },
  { id: 'P082', name: '河野 友美',     age: 32, gender: 'F', wardId: 'ward1', roomNumber: '108', bedLabel: '5', status: 'stable',       admitDate: '2026-03-01', doctorName: '岸本 医師', diagnosis: '不安障害' },
  { id: 'P083', name: '吉川 修',       age: 61, gender: 'M', wardId: 'ward1', roomNumber: '108', bedLabel: '6', status: 'stable',       admitDate: '2026-03-14', doctorName: '田村 医師', diagnosis: '認知症' },
  { id: 'P084', name: '南 真理子',     age: 44, gender: 'F', wardId: 'ward1', roomNumber: '109', bedLabel: '3', status: 'stable',       admitDate: '2026-03-04', doctorName: '森田 医師', diagnosis: '統合失調症' },
  { id: 'P085', name: '中島 大輔',     age: 27, gender: 'M', wardId: 'ward1', roomNumber: '109', bedLabel: '5', status: 'stable',       admitDate: '2026-03-19', doctorName: '岸本 医師', diagnosis: '適応障害' },
  { id: 'P086', name: '佐野 恵',       age: 52, gender: 'F', wardId: 'ward1', roomNumber: '109', bedLabel: '6', status: 'observation',  admitDate: '2026-03-25', doctorName: '田村 医師', diagnosis: 'うつ病' },
...
export const ISOLATION_ORDERS: IsolationOrder[] = [
  ...
  // --- P001 山田 太郎(統合失調症) ---
  {
    ...
    wardId: 'ward1', roomNumber: '101-1', doctorName: '田村 医師',
    restraintParts: ['右手首', '左手首'],
    linkedDocumentChecks: ['身体拘束に関する説明書・同意書', '行動制限実施記録'],
    confirmSigns: {
  ...
  // --- P002 佐藤 花子(うつ病・観察中) ---
  {
    ...
    wardId: 'ward1', roomNumber: '101-2', doctorName: '岸本 医師',
  ...
  // 既存の ISO001 が現行(2026-02-22 から継続中)
  {
    ...
    wardId: 'ward1', roomNumber: '102-1', doctorName: '森田 医師',
  ...
  // 既存の ISO002 が現行(2026-02-23 から継続中)
  {
    ...
    wardId: 'ward1', roomNumber: '103-1', doctorName: '田村 医師',
    linkedDocumentChecks: ['隔離告知書', '行動制限実施記録'],
    confirmSigns: {
  ...
  // --- P005 田中 健太(適応障害) ---
  {
    ...
    wardId: 'ward1', roomNumber: '103-2', doctorName: '岸本 医師',
    restraintParts: ['体幹'],
