...
export const REVISIONS: Revision[] = [
  {
    ...
    summary: '看護経過記録のタグをフリータグ（自由入力＋Enter）で付与できるようにし、入力位置をテンプレート呼出の直下へ配置。部門記録簿でタグ検索・絞り込みを追加し、フローシートからの記録入力を看護経過記録ダイアログに統一しました（SPEC us-22／us-23）。',
    items: [
      {
      ...
      },
      {
        ...
        detail: 'フローシートの「看護記録」「新規作成」から開くダイアログを、フッターの記録入力と同一の看護経過記録ダイアログ（FOCUS/SOAP/フリー・テンプレート・タグ・連携）に統一。作成した記録は当該日の看護記録行にリンク表示する（セッション限定・リロードで消える）。',
      },
    ],
  },
  {
